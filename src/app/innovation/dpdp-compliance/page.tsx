    ...
    return (
        <>
            ...
            <ServicePageLayout
                ...
                subtitle="Trusync is your one-stop shop for dpdp compliance solution"
                painPoints={[
                ...
                features={[
                    { title: 'Gap Analysis', description: 'Comprehensive audit of current data practices against DPDP compliance requirements.' },
                    ...
                    { title: 'Compliance Dashboard', description: 'Real-time monitoring of DPDP compliance status.' },
                ]}
