...
- Name: contact-form.spec.ts >> Contact Form Inquiry Routing >> should route DPDP Compliance inquiry to contact form with correct service selected
- Location: tests/contact-form.spec.ts:28:7
...
Received: "http://localhost:3000/innovation/dpdp-compliance#assessment"
Timeout:  5000ms
...
Call log:
  - Expect "toHaveURL" with timeout 5000ms
    ...
    5 × locator resolved to <html lang="en" class="scroll-smooth">…</html>
      - unexpected value "http://localhost:3000/innovation/dpdp-compliance#assessment"
